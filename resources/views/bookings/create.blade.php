...
<div class="container">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('bookings') }}">
            ...
            <div class="row mb-3">
                <label for="idCustomer" class="col-md-4 col-form-label text-md-end">{{ __('Cliente') }}<b
            ...
            <div class="row mb-3">
                <label for="amount_people" class="col-md-4 col-form-label text-md-end">{{ __('Cantidad de personas') }}
            ...
            <div class="row mb-3">
                <label for="start_date" class="col-md-4 col-form-label text-md-end">{{ __('Fecha inicial') }}<b
                        class="text-danger">*</b></label>
            ...
            <div class="row mb-3">
                <label for="booking_hour" class="col-md-4 col-form-label text-md-end">{{ __('Hora de la reserva') }}<b
                        class="text-danger">*</b></label>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input id="booking_minutes" type="text" class="form-control" name="booking_minutes"
                           value="{{ old('booking_minutes') }}" required autocomplete="booking_minutes">
