        ...
        <form action="{{url('events')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <input value="{{old('entryPrice')}}" type="number"
                           class="form-control @error('entryPrice') is-invalid @enderror" name="entryPrice">
                </div>
                <div class="col">
                    <label for="idCardInput">Precio de decoración </label>
                    <input value="{{old('decorationPrice')}}" type="number"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-alternative">
                            ...
                            <input value="{{old('startDate', date('Y-m-d'))}}" type="text"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-alternative">
                            ...
                            <input value="{{old('endDate', date('Y-m-d'))}}" type="text"
