                ...
                <div class="col-4" style="border-right: 1px solid #ebebeb">
                    <div class="row card-body d-flex justify-content-start py-4">
                        <div class="form-group col-10">
                            ...
                            <select style="width: 100%" name="idCustomers" class="form-control" id="customer">
                        ...
                        <div class="form-group col-12">
                            ...
                            <select style="width: 100%" name="plates" id="plates" class="form-control" onchange="assign_price()">
                                <option value="">Seleccione</option>
                ...
                <div class="col-8">
                    <div class="input-group my-3 justify-content-end w-100">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-transparent" style="border: none"><h2>Precio total:&ensp;&ensp;<b
                                        class="text-success">$</b></h2></span>
                            <input
                                type="hidden"
        ...
        function add_plate() {
            ...
            if (cantidadInput > 0 && platillo > 0 && precioPlatillo > 0) {
                ...
                <td class="text-plate">
                    ...
                    <input type="hidden" name="descripciones[]" value="${descripcion}" class="description">
                    ${platillo_text}
                </td>
                <td>${descripcion}</td>
                <td>${precio}</td>
        ...
        function validatePlate() {
            ...
            if ($("#plates option:selected").val() != 1) {
                ...
                if ($("table#table_plates tbody tr").length > 0) {
                    $("table#table_plates tbody tr").each(function () {
                        if (
                            $(this).find("input.description").val().trim().toLowerCase() ==
