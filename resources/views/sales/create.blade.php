                    ...
                    <div class="row card-body d-flex justify-content-start py-4">
                        <div class="form-group col-10">
                            ...
                            <select name="idCustomers" class="form-control" id="customer">
                                ...
                                @foreach($customers as $value) @if($value->state == 1)
                                    <option
                                        name="{{$value->name}}"
                                        value="{{$value->id}}">
                                        {{$value->name}}
                        ...
                        <div class="form-group col-12">
                            <label for="plates">Platillo<b class="text-danger"> *</b></label>
                            <select
                                name="plates"
                                id="plates"
                                class="form-control"
                        ...
                        <div
                            ...
                            style="display: none"
                        >
                            <label for="plates">Descripcion<b class="text-danger"> *</b></label>
                            <input
                                type="text"
