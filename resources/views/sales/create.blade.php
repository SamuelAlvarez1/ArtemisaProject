        ...
        <div class="row">
            <div class="col-5" style="border-right: 1px solid #ebebeb;">
                <div class="row card-body d-flex justify-content-start py-4">
                    ...
                    <div class="col-12 d-flex justify-content-center" style="margin: 1% auto;">
            ...
            <div class="col-7">
                <div class="input-group my-3 justify-content-end">
                    <div class="input-group-prepend">
                        ...
                        <input type="number" class="form-control bg-transparent @error('totalPrice') is-invalid @enderror" name="totalPrice" readonly value="0" id="totalPrice" style="border:none; width:5rem">
                    @error('totalPrice')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
